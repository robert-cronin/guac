		...
		wantHM: []assembler.HasMetadataIngest{
			{
				...
				HasMetadata: &generated.HasMetadataInputSpec{
					Key:           "endoflife",
					Value:         "product:nodejs,cycle:14,version:14.17.0,isEOL:true,eolDate:2023-04-30,lts:true,latest:14.21.3",
					Timestamp:     tm,
		...
		wantHM: []assembler.HasMetadataIngest{
			{
				...
				HasMetadata: &generated.HasMetadataInputSpec{
					Key:           "endoflife",
					Value:         "product:python,cycle:3.9,version:3.9.5,isEOL:false,eolDate:2025-10-05,lts:false,latest:3.9.16",
					Timestamp:     tm,
					Justification: "Retrieved from endoflife.date",
				},
			},
